...
; ported to CBM2, comments by Vossi 05/2020
!cpu 6510
!to "amind700.prg", cbm
; ***************************************** CONSTANTS *********************************************
...
*= $0003
		...
		!byte $31, $36, $39, $3A, $97, $38, $35, $2C, $31, $3A, $97, $38, $36, $2C, $31, $33
		!byte $33, $3A, $97, $38, $37, $2C, $30, $3A, $97, $38, $38, $2C, $32, $33, $34, $3A
		!byte $9E, $38, $33, $00, $00, $00, $9E, $31, $37, $36, $00, $00, $00
		; 10 poke83,120:poke84,169:poke85,1:poke86,133:poke87,0:poke88,234:sys83
; ***************************************** ZERO PAGE *********************************************
!zone zeropage
*= $0040
...
vmptr:	!byte <(Screen), >(Screen)				; Screen address pointer
...
skip:
		...
		sbx #$31						; ILLEGAL opcode X = (A & X) - imm
		stx <(vmptr+ZPDIFF)+1			;   0-7 - $30 -> $cf-$d6
		eor #$07
; $87
bassdone:
...
; $cc main routine
start:	bit $ff		; **** DUMMY - KERNAL IRQ writes $ff here to $cd ()
;		lda #$50						; VIC ECM, 24 lines
;		sta VIC+$11						
		nop
		nop
		nop
...
mod_op2:ora SID+$1c						; read SID envelope 3
		nop
;		pha								; not needed - no user chars - no VIC ;)
		asr #$04						; ILLEGAL opcode (A & imm) /2
		ldy #$80						; video matrix at $d000, font at $c000
; $df
